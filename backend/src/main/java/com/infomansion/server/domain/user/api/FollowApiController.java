...
public class FollowApiController {
    ...
    @GetMapping("/api/v1/following/recommend")
    public ResponseEntity<? extends BasicResponse> findRecommendfollowerRoom(Pageable pageable) {
        return ResponseEntity.status(HttpStatus.OK)
                .body(new CommonResponse<>(roomService.findRecommendRoomByFollowingUsers(pageable)));
    }
}