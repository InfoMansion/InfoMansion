...
public class PostApiController {
    ...
    @GetMapping("api/v1/posts/recommend/{userId}")
    public ResponseEntity<CommonResponse<List<PostRecommendResponseDto>>> findRecommendPostUser(@PathVariable Long userId) {
