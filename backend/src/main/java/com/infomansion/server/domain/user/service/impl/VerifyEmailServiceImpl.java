...
public class VerifyEmailServiceImpl implements VerifyEmailService {
    ...
    public void sendMail(String to, String sub, String text) {
        final MimeMessagePreparator preparator = new MimeMessagePreparator() {
            ...
            public void prepare(MimeMessage mimeMessage) throws Exception {
                ...
                helper.setTo(to);
                helper.setSubject("[Info`Mansion] 회원가입 이메일 인증");
    ...
    private String createVerificationEmail(String verificationLink) {
        return "<div id=\"readFrame\">\n" +
                ...
                "                    border=\"0\"\n" +
                "                    height=\"60\"\n" +
                "                    src=\"https://www.notion.so/image/https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F144b7f74-c4d6-42d8-b7cb-a5ae9736fae1%2Flogo.png?table=block&id=f1167747-a27b-4fe4-8754-ce1fc86dec5c&spaceId=2ad0c350-f7c4-49fc-8e10-0df09d3d599e&width=2000&userId=f7809fb4-8b68-4ac4-940d-e69a299a85e6&cache=v2\"\n" +
                "                    style=\"\n" +
                ...
                "                <tbody>\n" +
                "                  <tr>\n" +
                "                    <td align=\"center\" valign=\"top\" bgcolor=\"#E8A0BF\" style=\"border-radius: 24px\">\n" +
                "                      <a\n" +
