...
<img src="./images/room.gif" width=80%>
...
<img src="./images/editroom.gif" width=80%>
...
<img src="./images/post.gif" width=80%>
...
<img src="./images/shop.gif" width=80%>
...
![아키텍처1](images/architecture.png)

![아키텍처2](images/architecture2.png)

| ![API명세서](images/apidocs.png) | ![API명세서](images/apidocs2.png) |
| -------------------------------- | --------------------------------- |
...
![gibhub flow](images/githubflow.png)

### Label

| ![label](images/label.png) | ![label](images/labeling.png) |
| -------------------------- | ----------------------------- |
...
| ![scrum&sprint](images/scrum%26sprint1.png) | ![scrum&sprint](images/scrum%26sprint2.png) |
| ------------------------------------------- | ------------------------------------------- |
